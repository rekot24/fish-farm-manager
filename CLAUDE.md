...
- Per-device feature flag UI — checkboxes for every detector, action, and health response per device, including `DeviceConfig.death_behavior` and `TimerConfig.cascade_reset_*` added in Phase 6 (ROADMAP Phase 11) — next up
